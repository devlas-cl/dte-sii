...
class CertRunner {
   ...
   * @param {string} [opts.rutProveedor='77111222-3']
   * @param {string} [opts.nombreProveedor='EMPRESA EJEMPLO SPA']
  ...
  async completarDeclaracionBoletaPortal({
    ...
    rutProveedor    = '77111222-3',
    nombreProveedor = 'EMPRESA EJEMPLO SPA',
    correoProveedor = 'certificacion.sii@devlas.cl',
  } = {}) {
    const puppeteer = require('puppeteer');
    const cookieJar = await this._obtenerCookiesSII();

    // RUT empresa desde config (ej: "77111222-3")
